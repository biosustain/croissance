...
The parameter N :sub:`0` of the model can optionally be constrained. This is recommended if the value is known. The growth rate is only comparable between calculated growth phases if their N :sub:`0` (initial population) parameter points to a similar stage of actual growth.
